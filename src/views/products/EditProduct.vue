              ...
              <div class="row row-cols-1 row-cols-lg-2 gy-4">
                ...
                <div class="col">
                  ...
                  <div class="input-group">
                    ...
                    <select
                      v-model="product.reasonExemptionId"
                      class="form-control form-control-sm"
                    >
                      <option
...
<script>
import { EDIT_PRODUCT } from "@/store/products/product.constants";
...
export default {
  ...
  computed: {
    ...mapGetters("product", ["getProductById", "getMessage"]),
  ...
  methods: {
    update() {
      this.$store.dispatch(`product/${EDIT_PRODUCT}`, this.$data.product).then(
        () => {
